...
class AuthService {
  ...
  Future<UserModel?> signInWithGoogle() async {
    try {
      ...
      print('AuthService Google Sign-In Error: ${e.message}');
  ...
  Future<UserModel?> signInWithFacebook() async {
    try {
      ...
      print('✓ Created Firebase user: ${user.email}');
  ...
  Future<void> sendPasswordResetEmail(String email) async {
    try {
      ...
      print('Firebase Password Reset Error: ${e.message}');
  ...
  Future<bool> hasValidToken() async {
    try {
      ...
      print('AuthService Check Token Error: $e');
      return false;
    }
  }
}
